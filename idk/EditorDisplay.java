...
public class EditorDisplay extends JComponent {
	...
	/**
	 * Contructor method for EditorDisplay class
	 * @param s - settings from EditorModel class
	 */
	public EditorDisplay(Map m) {
		this.s = m;
	...
	/**
	 * This method displays("paints") elements of the traffic simulation
	 */
	public void paintComponent(Graphics gg) {
		...
		int xWidth = (int) windowWidth / width;
		int yHeight = (int) windowHeight / height;
